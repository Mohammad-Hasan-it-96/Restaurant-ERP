...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Uploaded images (products, logos, categories, profile pics)
                    // and the .env (secrets + deploy config) for full recovery.
                    // The database itself is dumped separately (see 'databases').
    ...
    'notifications' => [
        'notifications' => [
            // Mail disabled (no mailer configured). Backup health is surfaced
            // through LogService via the event listeners in AppServiceProvider
            // (backup.completed / backup.failed) — the seam that can later route
            // failures to the Telegram alert channel.
        ...
        // Mail notifications are disabled above; spatie still validates this as a
        // real email at config load, so keep a valid (overridable) placeholder.
        'mail' => [
