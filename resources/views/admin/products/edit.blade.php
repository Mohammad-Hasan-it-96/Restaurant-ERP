                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_weight_based" id="is_weight_based"
                                   value="1" {{ old('is_weight_based', $product->is_weight_based) ? 'checked' : '' }}>
                    ...
                    <div id="normal-price-section" class="col-md-3">
                        ...
                        <input type="number" step="0.01" min="0"
                               ...
                               id="price" name="price" value="{{ old('price', $product->is_weight_based ? '' : $product->price) }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="0.01" min="0"
                                                   ...
                                                   value="{{ old('price_per_kg', $product->is_weight_based ? $product->price_per_kg : '') }}">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 border rounded p-2">
                                            ...
                                            <div class="form-check me-3">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       value="{{ $weight->id }}"
                                                       {{ in_array($weight->id, old('weights', $selectedWeights)) ? 'checked' : '' }}>
